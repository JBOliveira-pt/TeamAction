...
export default function MedicoResponsavelClient({
    ...
    const fmtDate = (val: string | null) =>
        val
            ? new Date(val).toLocaleDateString("pt-PT", {
                  day: "2-digit",
                  month: "short",
                  year: "numeric",
              })
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 flex flex-col gap-1">
                    ...
                    <span
                        className={`text-2xl font-bold ${ativos.length === 0 ? "text-emerald-500" : "text-amber-500"}`}
                    >
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 flex flex-col gap-1">
                    ...
                    <span className="text-xs text-gray-400">
                        resolvido{resolvidos.length !== 1 ? "s" : ""}
                    </span>
                </div>
            </div>
                ...
                {registos.length === 0 ? (
                    ...
                    <div className="space-y-2">
                        {registos.map((r) => (
                            <div
                                key={r.id}
                                className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 flex items-start justify-between gap-3"
                            >
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                        ...
                                        {r.data_prevista_retorno &&
                                            ` · Retorno previsto: ${fmtDate(r.data_prevista_retorno)}`}
                                    </p>
                                    {r.observacoes && (
