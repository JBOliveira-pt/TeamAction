...
import EditarEpocaModal from "./_components/EditarEpocaModal.client";
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <EditarEpocaModal
                        epocaId={epoca.id}
                        dataInicio={epoca.data_inicio.toString().slice(0, 10)}
                        dataFim={epoca.data_fim.toString().slice(0, 10)}
                    />
                    <NovaEpocaModal />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 border border-violet-500/30 rounded-xl p-5">
                    ...
                    <p className={`text-2xl font-bold mt-2 ${estadoCor}`}>
                        {estado}
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 space-y-3">
                ...
                <div className="flex justify-between text-xs text-gray-400 dark:text-gray-500">
                    ...
                    <span>
                        {diasPassados} de {totalDias} dias
                    </span>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <span
                            className={`inline-flex px-2 py-1 rounded-full text-xs font-medium mt-0.5 ${
                                estado === "Em curso"
