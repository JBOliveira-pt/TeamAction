export default function EpocaAtualPage() {
    return (
        <div className="p-6 space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-white">Época Atual</h1>
                <p className="text-sm text-slate-400 mt-1">2024/2025 · Em curso</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
                    ...
                    <p className="text-2xl font-bold text-white mt-2">30 Jun 2025</p>
                </div>
                <div className="bg-slate-900 border border-emerald-500/30 rounded-xl p-5">
                    <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Meses Restantes</p>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-3">
                <div className="flex items-center justify-between">
                    <h2 className="text-sm font-semibold text-white">📅 Progresso da Época</h2>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-4">
                <h2 className="text-sm font-semibold text-white">🗓️ Fases da Época</h2>
                <div className="space-y-3">
                    {[
                        ...
                        <div key={f.fase} className="flex items-center justify-between py-3 border-b border-slate-800 last:border-0">
                            <div>
                                <p className="text-sm font-semibold text-white">{f.fase}</p>
                                <p className="text-xs text-slate-400 mt-0.5">{f.periodo}</p>
                            </div>
