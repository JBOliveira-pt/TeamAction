    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Informações da tua conta e do clube</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col items-center text-center space-y-4">
                        {/* Avatar */}
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900">{presidente.name}</h2>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-900 mt-0.5">{presidente.name}</p>
                            </div>
                            <div>
                                <p className="text-xs text-gray-500">Função</p>
                                <p className="text-sm font-medium text-gray-900 mt-0.5">Presidente</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-900 mt-0.5">{presidente.email}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-900 mt-0.5">{presidente.organization?.name}</p>
                            </div>
                            <div>
                                <p className="text-xs text-gray-500">Slug</p>
                                <p className="text-sm font-medium text-gray-900 mt-0.5">{presidente.organization?.slug}</p>
                            </div>
                        </div>
                    </div>
