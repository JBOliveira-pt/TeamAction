...
export function AdicionarMembroModal({
    ...
    const isSubmitDisabled =
        isPending ||
        !funcao ||
        (isTreinador && treinadorMode === "none") ||
        (isTreinador &&
            treinadorMode === "real" &&
            (!selectedUser || escaloesTreinador.length === 0)) ||
        (isTreinador && treinadorMode === "fake" && !fakeNome.trim());
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl p-6 space-y-5 max-h-[90vh] overflow-y-auto">
                        ...
                        >
                            ...
                            {/* Treinador → escolher modo real ou fake */}
                            {isTreinador && (
                                        ...
                                        <div className="space-y-2">
                                            <div className="px-3 py-2 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                                                <p className="text-xs text-amber-400">
                                                    ⚠️ Apenas treinadores
                                                    registados na plataforma com
                                                    cursos válidos.
                                                </p>
                                            </div>
                                    ...
                                    {treinadorMode === "fake" && (
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-[10px] text-gray-400">
                                                Se o email pertencer a um
                                                treinador registado, será
                                                enviado um convite de
                                                vinculação. Caso contrário, o
