...
const POSICOES = [
    "Guarda-Redes", "Central", "Lateral Esquerdo", "Lateral Direito",
    "Ponta Esquerdo", "Ponta Direito", "Pivot",
];
                    ...
                    <div className="relative w-full max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl p-6 space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Equipa: {equipaNome}</p>
                            </div>
                            <button
                                onClick={() => setOpen(false)}
                        ...
                        <form ref={formRef} action={action} className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                />
                                <label htmlFor="federado_equipa" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Federado
                                </label>
                            </div>
