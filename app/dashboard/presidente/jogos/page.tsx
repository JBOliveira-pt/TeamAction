...
const equipasUnicas = [
    "Todas",
    ...Array.from(new Set(jogos.map((j) => j.equipa))),
];
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Época 2024/2025 · Todos os escalões
                    </p>
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <span
                                                className={`px-2 py-1 rounded-full text-xs font-medium ${estadoStyle[j.estado]}`}
                                            >
                                                {j.estado}
                                            </span>
                                        </td>
