        ...
        <div className="p-6 space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    {comunicados.length} comunicado
                    {comunicados.length !== 1 ? "s" : ""} enviado
                    {comunicados.length !== 1 ? "s" : ""}
                </p>
            </div>
                            ...
                            {comunicados.map((c) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <span
                                            className={`px-2 py-1 rounded-full text-xs font-medium ${destinatariosStyle[c.destinatarios] ?? "bg-gray-500/10 text-gray-400"}`}
                                        >
                                            {c.destinatarios}
                                        </span>
                                    </td>
