...
function resolveClube(dados: {
    ...
    if (dados.clube_nome) return { value: "Associado", color: "green" };
    if (dados.clube_pendente) return { value: "Pendente", color: "orange" };
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 flex flex-col">
                    ...
                    <div className="flex flex-col flex-1 justify-between">
                            ...
                            details={[
                                ...(dados?.clube_nome
                                    ? [
                                          {
                                              label: "Nome",
                                              value: dados.clube_nome,
                                          },
                                      ]
                                    : []),
                                ...(dados?.clube_pendente && !dados?.clube_nome
                                    ? [
                                          {
                                              label: "Pedido",
                                              value: dados.clube_pendente,
                                          },
                                      ]
                                    : []),
                            ]}
                        ...
                        <InfoSection
                            ...
                            badge={treinador}
                            details={[
                                ...(dados?.treinador_nome
                                    ? [
                                          {
                                              label: "Nome",
                                              value: dados.treinador_nome,
                                          },
                                      ]
                                    : []),
                                ...(dados?.treinador_email
                                    ? [
                                          {
                                              label: "E-mail",
                                              value: dados.treinador_email,
                                          },
                                      ]
                                    : []),
                            ]}
