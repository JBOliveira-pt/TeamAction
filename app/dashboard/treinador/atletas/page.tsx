// Página de atletas do treinador.
import EquipaAtletas from "../equipa-atletas/equipa-atletas.client";
    ...
    const [atletas, equipas] = await Promise.all([
        ...
        >`
            SELECT a.id, a.nome, a.posicao, a.numero_camisola, a.estado,
                   a.equipa_id, e.nome AS equipa_nome, a.user_id, a.data_nascimento,
                   u.image_url
            FROM atletas a
