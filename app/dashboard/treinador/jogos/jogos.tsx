    ...
    return (
        <div className="w-full min-h-[100vh] bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-6">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 w-full max-w-lg relative border border-blue-100 dark:border-blue-900">
                        ...
                        >
                            ...
                            <div className="flex gap-2 mt-4">
                                <button
                                    type="submit"
                                    className="flex-1 bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 rounded-lg transition-all"
                                >
                                    Guardar
                                </button>
                                <button
            ...
            <div className="mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-amber-700 dark:text-amber-400 flex items-center gap-3 mb-1">
                        <span>🏆</span> Jogos
                    </h2>
                ...
                <button
                    className="px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl font-bold text-base shadow transition-all flex items-center gap-2"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white dark:bg-gray-800 border border-orange-200 dark:border-orange-700 rounded-xl p-6 shadow-md flex flex-col justify-between">
                    ...
                    <span className="text-xs text-gray-400 dark:text-gray-500">8V · 2E · 2D</span>
                </div>
                    ...
                    <table className="min-w-full text-sm">
                        ...
                        <tbody>
                            {gamesData.map((g, idx) => (
                                ...
                                >
                                    <td className="p-3 font-medium text-blue-600 dark:text-blue-400 whitespace-nowrap">
                                        {g.date}
                                    </td>
