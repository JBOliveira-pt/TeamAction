...
export function ScrollTagline() {
    ...
    useEffect(() => {
        ...
        const onScroll = () => {
            ...
            // Distância fixa para a animação (independente da altura do wrapper)
            const totalDistance = vh * 2;
    ...
    return (
        ...
        <div ref={wrapperRef} className="relative" style={{ height: "260vh" }}>
            ...
            >
                <div className="relative w-full max-w-[1500px] mx-auto h-full flex items-center">
                    <div className="w-full max-w-[740px] pl-8 sm:pl-12 md:pl-40">
                        {lines.map((line, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p
                                        className="text-5xl md:text-5xl font-extrabold tracking-[0rem] leading-snug lg:leading-[1.11] 2xl:leading-[1.11] text-slate-900 will-change-transform drop-shadow-[0_4px_24px_rgba(15,23,42,0.12)]"
                                        style={{
                                            opacity: eased,
                    ...
                    <div
                        ref={videoRef}
                        className="absolute right-30 w-[500px] aspect-square pointer-events-none will-change-transform z-20"
                        style={{
                            top: "-60%",
